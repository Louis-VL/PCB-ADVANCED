...
##Header JB (header 2)
#set_property PACKAGE_PIN M11 [get_ports {JB[1]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {JB[1]}]
#set_property PACKAGE_PIN M12 [get_ports {JB[2]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {JB[2]}]
#set_property PACKAGE_PIN P12 [get_ports {JB[3]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {JB[3]}]
#set_property PACKAGE_PIN P13 [get_ports {JB[4]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {JB[4]}]
#set_property PACKAGE_PIN P10 [get_ports {JB[5]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {JB[5]}]
#set_property PACKAGE_PIN P11 [get_ports {JB[6]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {JB[6]}]
#set_property PACKAGE_PIN N10 [get_ports {JB[7]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {JB[7]}]
#set_property PACKAGE_PIN N11 [get_ports {JB[8]}]
