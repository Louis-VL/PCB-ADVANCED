...
HD_PWD='C:/Users/louis/Documents/Github/PCB ADVANCED/PCB-ADVANCED/VIVADO/SpartanTest/SpartanTest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SmallTester.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SmallTester.tcl
