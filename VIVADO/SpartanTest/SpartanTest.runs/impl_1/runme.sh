...
HD_PWD='C:/Users/louis/Documents/Github/PCB ADVANCED/PCB-ADVANCED/VIVADO/SpartanTest/SpartanTest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SmallTester.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SmallTester.tcl -notrace
