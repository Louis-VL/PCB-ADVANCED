...
HD_PWD='C:/Users/louis/Documents/Github/PCB-ADVANCED/PCB-ADVANCED/VIVADO/SpartanMicroBlaze/SpartanMicroBlaze.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroBlazeV2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MicroBlazeV2_wrapper.tcl -notrace
