...
vlog -work xpm  -incr -mfcu  -sv "+incdir+../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
...
vlog -work blk_mem_gen_v8_4_6  -incr -mfcu  "+incdir+../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
"../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/bb55/simulation/blk_mem_gen_v8_4.v" \

vlog -work xil_defaultlib  -incr -mfcu  "+incdir+../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
...
vlog -work generic_baseblocks_v2_1_0  -incr -mfcu  "+incdir+../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
"../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/b752/hdl/generic_baseblocks_v2_1_vl_rfs.v" \

vlog -work axi_infrastructure_v1_1_0  -incr -mfcu  "+incdir+../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
"../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \

vlog -work axi_register_slice_v2_1_28  -incr -mfcu  "+incdir+../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
"../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/87d1/hdl/axi_register_slice_v2_1_vl_rfs.v" \

vlog -work fifo_generator_v13_2_8  -incr -mfcu  "+incdir+../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
...
vlog -work axi_data_fifo_v2_1_27  -incr -mfcu  "+incdir+../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
"../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/fab7/hdl/axi_data_fifo_v2_1_vl_rfs.v" \

vlog -work axi_crossbar_v2_1_29  -incr -mfcu  "+incdir+../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
