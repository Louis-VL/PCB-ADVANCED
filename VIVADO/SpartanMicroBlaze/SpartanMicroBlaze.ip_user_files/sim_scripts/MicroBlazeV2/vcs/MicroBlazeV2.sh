...
#
# Script generated by Vivado on Wed Dec 20 10:45:26 +0100 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : MicroBlazeV2.sh
...
#
# Usage        : MicroBlazeV2.sh
#                MicroBlazeV2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                MicroBlazeV2.sh [-reset_run]
#                MicroBlazeV2.sh [-reset_log]
#                MicroBlazeV2.sh [-help]
#
...
#                script (type 'MicroBlazeV2.sh -help' for more information).
#
...
design_libs=(xpm microblaze_v11_0_11 xil_defaultlib lmb_v10_v3_0_12 lmb_bram_if_cntlr_v4_0_22 blk_mem_gen_v8_4_6 axi_lite_ipif_v3_0_4 mdm_v3_2_24 lib_cdc_v1_0_2 proc_sys_reset_v5_0_13 interrupt_control_v3_1_4 axi_gpio_v2_0_30 generic_baseblocks_v2_1_0 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_28 fifo_generator_v13_2_8 axi_data_fifo_v2_1_27 axi_crossbar_v2_1_29 lib_pkg_v1_0_2 lib_srl_fifo_v1_0_2 axi_uartlite_v2_0_32)

# simulation root library directory
sim_lib_dir="vcs_lib"

# script info
echo -e "MicroBlazeV2.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./MicroBlazeV2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" +incdir+"../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
  ...
  vlogan -work blk_mem_gen_v8_4_6 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" +incdir+"../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" +incdir+"../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
  ...
  vlogan -work generic_baseblocks_v2_1_0 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" +incdir+"../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
  "../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/b752/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" +incdir+"../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
  "../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_register_slice_v2_1_28 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" +incdir+"../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
  "../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/87d1/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work fifo_generator_v13_2_8 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" +incdir+"../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
  ...
  vlogan -work axi_data_fifo_v2_1_27 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" +incdir+"../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
  "../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/fab7/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_crossbar_v2_1_29 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" +incdir+"../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.MicroBlazeV2 xil_defaultlib.glbl -o MicroBlazeV2_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./MicroBlazeV2_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key MicroBlazeV2_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc MicroBlazeV2_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./MicroBlazeV2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: MicroBlazeV2.sh [-help]\n\
Usage: MicroBlazeV2.sh [-step]\n\
Usage: MicroBlazeV2.sh [-lib_map_path]\n\
Usage: MicroBlazeV2.sh [-reset_run]\n\
Usage: MicroBlazeV2.sh [-reset_log]\n\
Usage: MicroBlazeV2.sh [-keep_index]\n\
Usage: MicroBlazeV2.sh [-noclean_files]\n\n\
