...
design_libs=(simprims_ver xpm microblaze_v11_0_11 xil_defaultlib lmb_v10_v3_0_12 lmb_bram_if_cntlr_v4_0_22 blk_mem_gen_v8_4_6 axi_lite_ipif_v3_0_4 mdm_v3_2_24 lib_cdc_v1_0_2 proc_sys_reset_v5_0_13 interrupt_control_v3_1_4 axi_gpio_v2_0_30 generic_baseblocks_v2_1_0 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_28 fifo_generator_v13_2_8 axi_data_fifo_v2_1_27 axi_crossbar_v2_1_29 lib_pkg_v1_0_2 lib_srl_fifo_v1_0_2 axi_uartlite_v2_0_32)
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" +incdir+"../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
  ...
  xmvlog -work blk_mem_gen_v8_4_6 $xmvlog_opts +incdir+"$ref_dir/../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" +incdir+"../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$ref_dir/../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" +incdir+"../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
  ...
  xmvlog -work generic_baseblocks_v2_1_0 $xmvlog_opts +incdir+"$ref_dir/../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" +incdir+"../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
  "../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/b752/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"$ref_dir/../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" +incdir+"../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
  "../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_28 $xmvlog_opts +incdir+"$ref_dir/../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" +incdir+"../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
  "../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/87d1/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work fifo_generator_v13_2_8 $xmvlog_opts +incdir+"$ref_dir/../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" +incdir+"../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
  ...
  xmvlog -work axi_data_fifo_v2_1_27 $xmvlog_opts +incdir+"$ref_dir/../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" +incdir+"../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
  "../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/fab7/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_crossbar_v2_1_29 $xmvlog_opts +incdir+"$ref_dir/../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" +incdir+"../../../../SpartanMicroBlaze.gen/sources_1/bd/MicroBlazeV2/ipshared/ec67/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.MicroBlazeV2 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.MicroBlazeV2 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log MicroBlazeV2_sc.so .tmp_log xcelium_lib waves.shm c.obj)
